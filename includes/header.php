  ...
  <div id="mycarousel" class="carousel slide">
    ...
    <div  class="carousel-inner">
      ...
      <div class="item active">
        <img src="media/1.jpg" alt="image1" class="img-responsive">

      </div>

      <div class="item">
        <img src="media/2.jpg" alt="image1" class="img-responsive">

      </div>

      <div class="item">
        <img src="media/3.jpg" alt="image1" class="img-responsive">
